...
[assembly: AssemblyDescription("Lanceur portable Python .NET Native — basé sur le code source PyLibrePortable de Binventeur-Labs, sous licence GNU GPLv3.")] // -> Commentaires et description secondaire : indique le rôle du programme.
